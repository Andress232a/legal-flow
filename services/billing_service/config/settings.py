...
DATABASES = {
    "default": {
        ...
        "NAME": os.environ.get("MYSQL_DATABASE") or os.environ.get("DATABASE_NAME", "legalflow_billing"),
...
REST_FRAMEWORK = {
    "DEFAULT_AUTHENTICATION_CLASSES": (
        "apps.billing.authentication.ServiceJWTAuthentication",
    ),
...
SPECTACULAR_SETTINGS = {
    ...
    "DESCRIPTION": "Servicio de Facturación para la plataforma LegalFlow",
    "VERSION": "1.0.0",
