...
SECRET_KEY = os.environ.get("SECRET_KEY", "dev-insecure-timetracking-secret-key-change-me")
...
DATABASES = {
    "default": {
        ...
        "NAME": os.environ.get("MYSQL_DATABASE") or os.environ.get("DATABASE_NAME", "legalflow_timetracking"),
...
REST_FRAMEWORK = {
    "DEFAULT_AUTHENTICATION_CLASSES": (
        "apps.time_tracking.authentication.IamJWTAuthentication",
    ),
...
SPECTACULAR_SETTINGS = {
    ...
    "DESCRIPTION": "Microservicio de Control de Tiempo para la plataforma LegalFlow",
    "VERSION": "1.0.0",
