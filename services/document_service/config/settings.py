...
DATABASES = {
    "default": {
        ...
        "NAME": os.environ.get("DATABASE_NAME", "legalflow_documents"),
...
REST_FRAMEWORK = {
    "DEFAULT_AUTHENTICATION_CLASSES": (
        "apps.documents.authentication.ServiceJWTAuthentication",
    ),
...
SPECTACULAR_SETTINGS = {
    ...
    "DESCRIPTION": "Servicio de Gestión Documental para la plataforma LegalFlow",
    "VERSION": "1.0.0",
...
# IAM Service URL for permission checks
IAM_SERVICE_URL = os.environ.get("IAM_SERVICE_URL", "http://localhost:8001")

# Document storage
DOCUMENT_STORAGE_PATH = os.environ.get("DOCUMENT_STORAGE_PATH", str(BASE_DIR / "media" / "documents"))
